...
- **Fabric Loader:** 0.18.4+ (Fabric API 0.141.2+1.21.11)
- **NeoForge:** 21.1.174+
...
2. Ensure you have the correct mod loader installed (Fabric + Fabric API, or NeoForge) for your version of Minecraft.
