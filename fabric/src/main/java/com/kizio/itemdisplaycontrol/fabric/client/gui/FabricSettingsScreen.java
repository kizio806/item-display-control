...
public final class FabricSettingsScreen extends Screen {
    ...
    public void extractRenderState(net.minecraft.client.gui.GuiGraphicsExtractor extractor, int mouseX, int mouseY, float partialTick) {
        ...
        extractor.centeredText(
                this.font,
                Component.translatable(TranslationKeys.SCREEN_SETTINGS_SUBTITLE),
                centerX,
                34,
                0xA0A0A0
        );
        ...
        extractor.centeredText(
                this.font,
                Component.translatable(TranslationKeys.GUI_DESC_PRIMARY),
                centerX,
                this.height - 48,
                0xA0A0A0
        );
        extractor.centeredText(
                this.font,
                Component.translatable(TranslationKeys.GUI_DESC_RULES),
                centerX,
                this.height - 36,
                0xA0A0A0
        );
        extractor.centeredText(
                this.font,
                Component.translatable(TranslationKeys.GUI_DESC_SECONDARY),
                centerX,
                this.height - 24,
                0xA0A0A0
        );
    ...
    private void refreshButtonLabels() {
        toggleButton.setMessage(Component.translatable(TranslationKeys.GUI_ENABLED, booleanText(ItemDisplayControl.isEnabled())));
        whitelistButton.setMessage(Component.translatable(TranslationKeys.GUI_WHITELIST_TOGGLE, booleanText(ItemDisplayControl.isWhitelistEnabled())));
        blacklistButton.setMessage(Component.translatable(TranslationKeys.GUI_BLACKLIST_TOGGLE, booleanText(ItemDisplayControl.isBlacklistEnabled())));
    ...
    private Component booleanText(boolean enabled) {
